"""
Django settings for sarwas project.
...
SECRET_KEY = 'django-insecure-w!#+2j7jjz@1o9+r$gocsqyntx2#0d1at(=af2-!p+=tm$9$=y'
...
WSGI_APPLICATION = 'sarwas.wsgi.application'
